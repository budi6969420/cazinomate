...
public class KeycloakService {
    ...
    public boolean verifyEmail(String userId) {
        ...
        Map<String, Object> emailVerificationPayload = Map.of("emailVerified", true);
        HttpEntity<Map<String, Object>> request = new HttpEntity<>(emailVerificationPayload, headers);
        ResponseEntity<Void> response = restTemplate.exchange(
                keycloakUrl + "/admin/realms/" + realm + "/users/" + userId,
                HttpMethod.PUT,
                request,
    ...
    public boolean changeUsername(String userId, String newUsername) {
        ...
        Map<String, Object> usernamePayload = Map.of("username", newUsername);
        HttpEntity<Map<String, Object>> request = new HttpEntity<>(usernamePayload, headers);
        ResponseEntity<Void> response = restTemplate.exchange(
                keycloakUrl + "/admin/realms/" + realm + "/users/" + userId,
                HttpMethod.PUT,
                request,
    ...
    public boolean verifyPassword(String userId, String password) {
        ...
        HttpEntity<Map<String, Object>> request = new HttpEntity<>(passwordPayload, headers);
        ResponseEntity<Map> response = restTemplate.exchange(
                keycloakUrl + "/realms/" + realm + "/users/" + userId + "/verify-password",
                HttpMethod.POST,
                request,
                Map.class
        );

        return response.getBody() != null && Boolean.TRUE.equals(response.getBody().get("isValid"));
    }
